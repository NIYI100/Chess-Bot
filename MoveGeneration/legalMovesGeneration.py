...
from MoveGeneration.moveChecks import check_if_square_is_empty, check_if_square_is_capturable, \
    get_castling_moves_if_possible
...
def get_legal_moves(state):
    ...
    advances += get_castling_moves_if_possible(state)
